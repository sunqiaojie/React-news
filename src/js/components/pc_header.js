				...
				<Row>
					...
					<Col span={16}>
						<Menu mode="horizontal" onClick={this.handleClick.bind(this)} selectedKeys={[this.state.current]}>
							...
							<Menu.Item key="shehui" disabled>
								<Icon type="appstore"/>社会
							</Menu.Item>
							<Menu.Item key="guonei" disabled>
								<Icon type="appstore"/>国内
							</Menu.Item>
							<Menu.Item key="guoji" disabled>
								<Icon type="appstore"/>国际
							</Menu.Item>
							<Menu.Item key="yule" disabled>
								<Icon type="appstore"/>娱乐
							</Menu.Item>
							<Menu.Item key="tiyu" disabled>
								<Icon type="appstore"/>体育
							</Menu.Item>
							<Menu.Item key="keji" disabled>
